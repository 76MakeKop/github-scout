"""CLI. Конвейер доходит до конца Слоя 2 и останавливается перед сборкой отчёта.

Отчёта здесь ещё нет — это день 13 ROADMAP.md. Аудиты печатаются построчно,
в порядке, который посчитал код, а не в виде пятёрки с provenance.
